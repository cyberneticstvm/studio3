...
$(function () {
    mousecursor();
    animate(text1, 0, 95, 7000);
    animate(text2, 0, 92, 7000);
    animate(text3, 0, 90, 7000);
    animate(text4, 0, 90, 7000);
});
...
function animate(obj, initVal, lastVal, duration) {
 ...
 let text1 = document.getElementById('skill1');
 let text2 = document.getElementById('skill2');
 let text3 = document.getElementById('skill3');
 let text4 = document.getElementById('skill4');
